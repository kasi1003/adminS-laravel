                                                        ...
                                                        @if ($showEditModal)
                                                            <form>
                                                                <div class="form-group">
                                                                    ...
                                                                    <input wire:model="selectedCemetery.CemeteryName"
                                                                        type="text" class="form-control"
                                                                        id="CemeteryName">
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="Town">Town</label>
                                                                    <input wire:model="selectedCemetery.Town" type="text"
                                                                        class="form-control" id="Town">
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="NumberOfSections">Number of Sections</label>
                                                                    <input wire:model="selectedCemetery.NumberOfSections"
                                                                        type="number" class="form-control"
                                                                        id="NumberOfSections">
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="TotalGraves">Total Graves</label>
                                                                    <input wire:model="selectedCemetery.TotalGraves"
                                                                        type="number" class="form-control"
                                                                        id="TotalGraves">
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="AvailableGraves">Available Graves</label>
                                                                    <input wire:model="selectedCemetery.AvailableGraves"
                                                                        type="number" class="form-control"
                                                                        id="AvailableGraves">
                                                                </div>
