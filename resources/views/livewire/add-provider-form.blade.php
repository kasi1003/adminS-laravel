    ...
    <div class="card mt-5" style="width: 100%;">
        <div class="card-body">
            <form wire.submit="addProvider">
                ...
                <div class="mb-3 d-flex flex-column">
                    <label for="number" class="form-label">Service Provider Contact Number</label>
                    <input type="number" wire:model="number" placeholder="Enter Service Provider Number">
                </div>


                <div class="mb-3 d-flex flex-column">
                    <label for="number" class="form-label">Number of Services</label>
